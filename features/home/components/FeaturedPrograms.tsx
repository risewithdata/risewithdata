        ...
        <div className="overflow-hidden rounded-2xl border border-slate-800 bg-slate-900 shadow-lg">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 px-7 py-6">
            ...
            <div className="flex items-start gap-4">
              <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-brand-500 text-white text-lg">
                📊
              </div>
              <div>
                <div className="flex flex-wrap items-center gap-2">
                  <span className="rounded-full bg-brand-500/20 px-2.5 py-0.5 text-xs font-semibold text-brand-600">
                    Flagship
                  </span>
            ...
            <a
              ...
              className="flex-shrink-0 self-start rounded-xl bg-brand-500 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-brand-500 sm:self-center"
            >
              View Fellowship →
            </a>
          </div>
        ...
        <div className="mt-3 grid gap-3 sm:grid-cols-2">
          {cohorts.map((cohort, i) => (
            <a
              ...
              className="group relative flex items-center justify-between overflow-hidden rounded-2xl border border-slate-200 bg-white px-6 py-5 shadow-sm transition hover:border-brand-500 hover:shadow-md"
            >
              {/* Left connector line */}
              <div className="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-brand-600 to-brand-500 opacity-0 transition group-hover:opacity-100" />

              <div className="flex items-center gap-4">
                {/* Sub-indent indicator */}
                <div className="flex flex-col items-center gap-0.5 self-stretch py-1">
                  <div className="w-px flex-1 bg-slate-200" />
                  <div className="h-1.5 w-1.5 rounded-full bg-slate-300 group-hover:bg-brand-500" />
                  <div className="w-px flex-1 bg-slate-200" />
                </div>

                <div>
                  <div className="flex items-center gap-2">
                    <span className="rounded-full bg-brand-500 px-2.5 py-0.5 text-xs font-semibold text-brand-600">
                      {cohort.badge}
                    </span>
                  </div>
                  <p className="mt-1 text-sm font-semibold text-slate-800 group-hover:text-brand-600">
                    {cohort.title}
                  </p>
              ...
              <span className="ml-3 flex-shrink-0 text-slate-300 transition group-hover:translate-x-1 group-hover:text-brand-600">
                →
              </span>
            </a>
          ))}
