    ...
    <InstructorLayout>
      <div className="px-6 py-8 max-w-3xl">
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-slate-500">Manage your instructor account information and password</p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="flex items-center gap-5">
                <div
                  className="flex flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-brand-500 to-brand-700 text-2xl font-bold text-white"
                ...
                <div>
                  ...
                  <div className="mt-1.5 flex items-center gap-2">
                    ...
                    <span className={`rounded-full px-2.5 py-0.5 text-xs font-semibold ${
                      profile.active ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-600'
                    }`}>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 flex items-center gap-3">
                ...
                {saveMsg && (
                  <span className={`text-sm font-medium ${saveMsg.includes('successfully') ? 'text-emerald-600' : 'text-red-600'}`}>
                    {saveMsg}
                  </span>
                )}
              </div>
