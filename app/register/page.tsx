    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-600 bg-slate-800 px-4 py-2.5 text-sm text-white placeholder-slate-500 outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20"
          />
        </div>
        <div>
      ...
      <div>
        ...
        <input
          ...
          autoComplete="email"
          className={`w-full rounded-xl border px-4 py-2.5 text-sm text-white placeholder-slate-500 outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 ${
            prefEmail
              ? 'border-slate-700 bg-brand-950/80 cursor-not-allowed opacity-70'
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className="w-full rounded-xl border border-slate-600 bg-slate-800 px-4 py-2.5 pr-10 text-sm text-white placeholder-slate-500 outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20"
          />
          ...
          <input
            ...
            className={`w-full rounded-xl border bg-slate-800 px-4 py-2.5 pr-10 text-sm text-white placeholder-slate-500 outline-none focus:ring-2 ${
              confirm && confirm !== password
                ...
                : 'border-slate-600 focus:border-brand-500 focus:ring-brand-500/20'
            }`}
          />
      ...
      <button
        ...
        className="w-full rounded-xl bg-gradient-to-r from-brand-600 to-brand-500 py-3 text-sm font-semibold text-white shadow-lg shadow-brand-700/25 transition hover:from-brand-700 hover:to-brand-600 disabled:opacity-50"
      >
        {loading ? (
      ...
      <p className="text-center text-xs text-slate-500">
        ...
        <a href="/login" className="font-semibold text-brand-400 hover:text-brand-600">Sign in</a>
      </p>
    </form>
  );
}
      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          <a href="/" className="inline-block rounded-2xl bg-warm-100 px-5 py-3">
            <img src="/logo.jpeg" alt="RiseWithData" className="mx-auto h-14 w-auto" />
          </a>
        </div>

        {/* Card */}
        <div className="rounded-2xl border border-brand-900 bg-brand-950/80 p-8 shadow-2xl">
          <div className="mb-6 text-center">
            <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-brand-500/20">
